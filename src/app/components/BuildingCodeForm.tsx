/**
 * components/BuildingCodeForm.tsx — Building Access Code Form
 *
 * Reusable form for building code entry. Used on both the homepage (resident/family)
 * and the responder portal. The redirectTo prop controls destination after
 * successful validation — role selection page for public, responder dashboard for responders.
 * 
 * Fully accessible with aria-live error announcements and screen reader labels.
 */
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <Button
          ...
          variant="primary"
          aria-label={
            isSubmitting ? "Searching for building..." : "Find building"
          }
        >
