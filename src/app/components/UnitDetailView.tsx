...
import { getResourceLabel, getResponderStatusDisplay, getStatusDisplay } from '@/lib/reportUtils'
    ...
    return (
      <main className="min-h-screen bg-slate-50 px-4 py-10">
        <div className="w-full max-w-lg mx-auto space-y-6">
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-1">Unit Detail</p>
            <h1 className="text-2xl font-bold text-slate-900">No report submitted</h1>
            <p className="text-sm font-medium text-slate-500 mt-1">
              This unit has not submitted a safety report. You can still update the responder status below.
            </p>
          </div>

          <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-3">
            <p className="text-sm font-bold text-slate-700">Update responder status</p>
        ...
        <div className="bg-white rounded-xl border border-slate-200 divide-y divide-slate-100">
          ...
          {report.notes && isResponder && (
            <div className="px-5 py-4">
              ...
              <p className="text-base font-medium text-slate-900">{report.notes}</p>
            </div>
          )}
