/**
 * building/[id]/page.tsx — Role Selection Page
 *
 * Entry point after building code is validated. Displays building details
 * and prompts the user to identify their role — resident or family member.
 * 
 * First responders access via the separate /responder portal.
 */
...
const roleOptions = [
  {
    ...
    icon: "🏠",
    className:
      "block w-full text-center px-8 py-4 bg-blue-600 text-white rounded-lg font-bold border-2 border-blue-600 hover:bg-transparent hover:text-blue-600 transition-colors cursor-pointer",
  },
  {
    ...
    icon: "👨‍👩‍👧",
    className:
      "block w-full text-center px-8 py-4 bg-slate-700 text-white rounded-lg font-bold border-2 border-slate-700 hover:bg-transparent hover:text-slate-700 transition-colors cursor-pointer",
  },
];
...
export default async function BuildingPage({
  ...
  return (
    <div>
      <Link href="/" className="underline font-bold text-lg">
        ← Back
      </Link>
